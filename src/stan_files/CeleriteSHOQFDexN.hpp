...
namespace model_CeleriteSHOQFDexN_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_CeleriteSHOQFDexN");
    reader.add_event(256, 254, "end", "model_CeleriteSHOQFDexN");
    return reader;
}
...
#include "stan_meta_header.hpp"
 class model_CeleriteSHOQFDexN
  : public stan::model::model_base_crtp<model_CeleriteSHOQFDexN> {
private:
        int N;
        vector_d t;
        vector_d y;
        ...
        double eps;
public:
    model_CeleriteSHOQFDexN(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_CeleriteSHOQFDexN_namespace::model_CeleriteSHOQFDexN";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_CeleriteSHOQFDexN_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_CeleriteSHOQFDexN";
    }
...
typedef model_CeleriteSHOQFDexN_namespace::model_CeleriteSHOQFDexN stan_model;
