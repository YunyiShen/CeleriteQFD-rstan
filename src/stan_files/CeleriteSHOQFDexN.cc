...
#include "CeleriteSHOQFDexN.hpp"

RCPP_MODULE(stan_fit4CeleriteSHOQFDexN_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_CeleriteSHOQFDexN")
